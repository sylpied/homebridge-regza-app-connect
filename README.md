...
Outside navigation mode, Up/Down change channel, Left selects terrestrial and Right selects BS. The first Select opens the configured guide/menu; arrows then become normal directional keys and Select becomes Enter.
